export default {
  ...
  // headerBtn:document.querySelector('[data-menu-btn]'),
  
  // reviewsSliders:document.querySelectorAll('.reviews-slider'),
  // servicesSwiper:document.querySelectorAll('.services-swiper'),
  // consultantSlider:document.querySelectorAll('.consultant-slider'),
}
